...
namespace Aga.Controls.Tree
{
	public class Node
	{
		...
		private class NodeCollection : Collection<Node>
		{
			...
			{
                if (_owner.TriggerEventsOnClear)
                {
                    while (this.Count != 0)
        ...
        Color foreColor;
        bool foreColorSet = false;
        public Color ForeColor
        {
            get { return foreColor; }
            set { foreColorSet = true; foreColor = value; }
        }
        public bool ForeColorSet
        {
            get { return foreColorSet; }
        }
        ...
        private bool TriggerEventsOnClear { get; set; }
		...
		public Node(string text)
		{
		    ...
		    TriggerEventsOnClear = true;
		}

        public Node(bool triggerEventOnClear) : this(string.Empty)
        {
            TriggerEventsOnClear = triggerEventOnClear;
        }
