...
{
    public class HookStateChangeInfo
    {
        public Hook Hook { get; private set; }
        public IRunningProcess Process { get; set; }
        public eNktHookState PreviousState { get; private set; }
        public eNktHookState CurrentState { get; private set; }
