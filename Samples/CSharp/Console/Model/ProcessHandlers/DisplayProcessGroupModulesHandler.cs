...
{
    internal class DisplayProcessGroupModulesHandler : NonTerminalHandler<IRunningProcess>
    {

        private readonly ApplicationPresenter _presenter;

        public DisplayProcessGroupModulesHandler(ApplicationPresenter applicationPresenter)
        {
        ...
        {
            //_presenter.RefreshSelectedProcessGroupModulesIfContains(aProcess);
