...
{
    internal class ProcessStartedSelectionRefreshHandler : NonTerminalHandler<IRunningProcess>
    {
        private ApplicationPresenter _presenter;

        public ProcessStartedSelectionRefreshHandler(ApplicationPresenter presenter)
        {
        ...
        {
            _presenter.UpdateProcessToSelectionIfItsGroupIsSelected(aProcess);
            return true;
        }
