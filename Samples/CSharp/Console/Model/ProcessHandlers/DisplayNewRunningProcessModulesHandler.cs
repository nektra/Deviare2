...
{
    internal class DisplayNewRunningProcessModulesHandler : NonTerminalHandler<IRunningProcess>
    {
        #region Fields
        ...
        public DisplayNewRunningProcessModulesHandler(ApplicationPresenter applicationPresenter)
        {
            _presenter = applicationPresenter;
        }

        protected override bool HandleCore(IRunningProcess aProcess)
        {
            _presenter.DisplaySelectedProcessesModulesIfWasAdded(aProcess);
            return true;
        }
