...
template <class T>
class ATL_NO_VTABLE CNktProcessEventsImpl : public IDelayableDynamicConnectionPoint<T, DNktProcessEvents>
{
public:
  HRESULT Fire_OnCustomDllLoad(__in INktProcess *lpProc, __in LONG nActionId, __in LONG hActionResult)
    ...
    for (i=0; ; i++)
    {
      ...
      if (SUCCEEDED(hRes))
      {
        ...
        aVarParams[2] = lpProc;
        aVarParams[1] = (LONG)nActionId;
        aVarParams[0] = hActionResult;
        hRes = FireCommon(cConnDisp, dispidNktProcessEventsOnCustomDllLoad, aVarParams, NKT_DV_ARRAYLEN(aVarParams));
      }
    }
    return S_OK;
    };
  ...
  HRESULT Fire_OnCustomDllUnload(__in INktProcess *lpProc, __in LONG nActionId, __in LONG hActionResult)
    ...
    for (i=0; ; i++)
    {
      ...
      if (SUCCEEDED(hRes))
      {
        ...
        aVarParams[1] = (LONG)nActionId;
        aVarParams[0] = hActionResult;
        hRes = FireCommon(cConnDisp, dispidNktProcessEventsOnCustomDllUnload, aVarParams, NKT_DV_ARRAYLEN(aVarParams));
      }
    }
    return S_OK;
    };
  ...
  HRESULT Fire_OnCustomApiCall(__in INktProcess *lpProc, __in LONG nActionId, __in LONG hActionResult,
    ...
    for (i=0; ; i++)
    {
      ...
      if (SUCCEEDED(hRes))
      {
        ...
        aVarParams[3] = lpProc;
        aVarParams[2] = (LONG)nActionId;
        aVarParams[1] = hActionResult;
        aVarParams[0] = (ULONG)nApiResult;
        hRes = FireCommon(cConnDisp, dispidNktProcessEventsOnCustomApiCall, aVarParams, NKT_DV_ARRAYLEN(aVarParams));
      }
    }
    return S_OK;
    };

  HRESULT Fire_OnHookStateChanged(__in INktHook *lpHook, __in INktProcess *lpProc, __in eNktHookState nNewState,
    ...
    for (i=0; ; i++)
    {
      ...
      if (SUCCEEDED(hRes))
      {
        ...
        {
          hRes = FireCommon(cConnDisp, dispidNktProcessEventsOnHookStateChanged, aVarParams,
                            NKT_DV_ARRAYLEN(aVarParams));
        }
        else
        {
          hRes = FireWithDelay(cConnDisp, dispidNktProcessEventsOnHookStateChanged, aVarParams,
                               NKT_DV_ARRAYLEN(aVarParams));
        }
  ...
  HRESULT Fire_OnFunctionCalled(__in INktHook *lpHook, __in INktProcess *lpProc, __in INktHookCallInfo *lpCallInfo)
    ...
    for (i=0; ; i++)
    {
      ...
      if (SUCCEEDED(hRes))
      {
        ...
        hRes = FireCommon(cConnDisp, dispidNktProcessEventsOnFunctionCalled, aVarParams,
                          NKT_DV_ARRAYLEN(aVarParams));
      }
    }
    return S_OK;
  ...
  HRESULT Fire_OnCreateProcessCall(__in INktProcess *lpProc, __in LONG dwChildPid, __in LONG dwMainThreadId,
    ...
    for (i=0; ; i++)
    {
      ...
      if (SUCCEEDED(hRes))
      {
        ...
        hRes = FireCommon(cConnDisp, dispidNktProcessEventsOnCreateProcessCall, aVarParams,
                          NKT_DV_ARRAYLEN(aVarParams));
      }
    }
    return S_OK;
  ...
  HRESULT Fire_OnLoadLibraryCall(__in INktProcess *lpProc, __in LPCWSTR szLibraryNameW, __in VARIANT vtModule)
    ...
    for (i=0; ; i++)
    {
      ...
      if (SUCCEEDED(hRes))
      {
        ...
        if (FAILED(hRes))
          return hRes;
        hRes = FireCommon(cConnDisp, dispidNktProcessEventsOnLoadLibraryCall, aVarParams, NKT_DV_ARRAYLEN(aVarParams));
      }
    }
    return S_OK;
    };
  ...
  HRESULT Fire_OnLoadLibraryCall2(__in INktProcess *lpProc, __in LPCWSTR szLibraryNameW, __in my_ssize_t nModule)
    ...
    for (i=0; ; i++)
    {
      ...
      if (SUCCEEDED(hRes))
      {
        ...
        */
        hRes = FireCommon(cConnDisp, dispidNktProcessEventsOnLoadLibraryCall2, aVarParams, NKT_DV_ARRAYLEN(aVarParams));
      }
    }
    return S_OK;
    };
  ...
  HRESULT Fire_OnFreeLibraryCall(__in INktProcess *lpProc, __in VARIANT vtModule)
    ...
    for (i=0; ; i++)
    {
      ...
      if (SUCCEEDED(hRes))
      {
        ...
        if (FAILED(hRes))
          return hRes;
        hRes = FireCommon(cConnDisp, dispidNktProcessEventsOnFreeLibraryCall, aVarParams, NKT_DV_ARRAYLEN(aVarParams));
      }
    }
    return S_OK;
    };
  ...
  HRESULT Fire_OnFreeLibraryCall2(__in INktProcess *lpProc, __in my_ssize_t nModule)
    ...
    for (i=0; ; i++)
    {
      ...
      if (SUCCEEDED(hRes))
      {
        ...
        aVarParams[0].byref = (PVOID)nModule;
        */
        hRes = FireCommon(cConnDisp, dispidNktProcessEventsOnFreeLibraryCall2, aVarParams, NKT_DV_ARRAYLEN(aVarParams));
      }
    }
    return S_OK;
    };
  ...
  HRESULT Fire_OnAgentLoad(__in INktProcess *lpProc, __in LONG hErrorCode)
    ...
    for (i=0; ; i++)
    {
      ...
      if (SUCCEEDED(hRes))
      {
        ...
        aVarParams[1] = lpProc;
        aVarParams[0] = hErrorCode;
        if (hThreadRes != S_FALSE)
          hRes = FireCommon(cConnDisp, dispidNktProcessEventsOnAgentLoad, aVarParams, NKT_DV_ARRAYLEN(aVarParams));
        else
          hRes = FireWithDelay(cConnDisp, dispidNktProcessEventsOnAgentLoad, aVarParams, NKT_DV_ARRAYLEN(aVarParams));
        if (hRes == E_OUTOFMEMORY)
          return hRes;
      }
    }
  ...
  HRESULT Fire_OnAgentUnload(__in INktProcess *lpProc)
    ...
    for (i=0; ; i++)
    {
      ...
      if (SUCCEEDED(hRes))
      {
        ...
        aVarParams[0] = lpProc;
        hRes = FireCommon(cConnDisp, dispidNktProcessEventsOnAgentUnload, NULL, 0);
      }
    }
    return S_OK;
    };
  ...
  HRESULT Fire_OnCustomMessage(__in INktProcess *lpProc, __in VARIANT vtMsgCode, __in VARIANT vtMsgParam,
    ...
    for (i=0; ; i++)
    {
      ...
      if (SUCCEEDED(hRes))
      {
        ...
        hRes = FireCommon(cConnDisp, dispidNktProcessEventsOnCustomMessage, aVarParams, NKT_DV_ARRAYLEN(aVarParams));
      }
    }
    return S_OK;
    };
  ...
  HRESULT Fire_OnCustomMessage2(__in INktProcess *lpProc, __in my_ssize_t nMsgCode, __in my_ssize_t nMsgParam,
    ...
    for (i=0; ; i++)
    {
      ...
      if (SUCCEEDED(hRes))
      {
        ...
        aVarParams[2].lVal = (LONG)nMsgCode;
        aVarParams[1].vt = VT_I4;
        aVarParams[1].lVal = (LONG)nMsgParam;
        aVarParams[0].vt = VT_I4|VT_BYREF;
        aVarParams[0].plVal = (LONG*)nRetVal;
#elif defined _M_X64
        ...
        */
        hRes = FireCommon(cConnDisp, dispidNktProcessEventsOnCustomMessage2, aVarParams, NKT_DV_ARRAYLEN(aVarParams));
        /*
        if (SUCCEEDED(hRes))
  ...
  HRESULT Fire_OnHookOverwritten(__in INktHook *lpHook, __in INktProcess *lpProc)
    ...
    for (i=0; ; i++)
    {
      ...
      if (SUCCEEDED(hRes))
      {
        ...
        aVarParams[1] = lpHook;
        aVarParams[0] = lpProc;
        hRes = FireCommon(cConnDisp, dispidNktProcessEventsOnHookOverwritten, aVarParams, NKT_DV_ARRAYLEN(aVarParams));
      }
    }
    return S_OK;
    };
