...
long CreateDevice(HANDLE pCOM, UINT Adapter,D3DDEVTYPE DeviceType,HWND hFocusWindow,DWORD BehaviorFlags,D3DPRESENT_PARAMETERS* pPresentationParameters,IDirect3DDevice9** ppReturnedDeviceInterface);

long D3DXLoadMeshFromX(LPCTSTR pFilename, DWORD Options, HANDLE pD3DDevice, HANDLE *ppAdjacency, HANDLE *ppMaterials, HANDLE *ppEffectInstances, DWORD *pNumMaterials, HANDLE *ppMesh);

long D3DXLoadMeshFromXInMemory(HANDLE Memory, DWORD SizeOfMemory, DWORD Options, HANDLE pD3DDevice, HANDLE *ppAdjacency, HANDLE *ppMaterials, HANDLE *ppEffectInstances, DWORD *pNumMaterials, HANDLE *ppMesh);

long D3DXLoadMeshFromXof(HANDLE pxofMesh, DWORD Options, HANDLE pDevice, HANDLE *ppAdjacency, HANDLE *ppMaterials, HANDLE *ppEffectInstances, DWORD *pNumMaterials, HANDLE *ppMesh);

long D3DXLoadMeshFromXResource(HANDLE Module, LPCSTR Name, LPCSTR Type, DWORD Options, HANDLE pD3DDevice, HANDLE *ppAdjacency, HANDLE *ppMaterials, HANDLE *ppEffectInstances,DWORD *pNumMaterials, HANDLE *ppMesh);

long D3DXLoadPatchMeshFromXof(HANDLE pxofMesh,DWORD Options,HANDLE pD3DDevice, HANDLE *ppMaterials, HANDLE *ppEffectInstances, PDWORD pNumMaterials, HANDLE *ppMesh);

long D3DXLoadSkinMeshFromXof(HANDLE pxofMesh, DWORD Options, HANDLE pD3DDevice, HANDLE *ppAdjacency, HANDLE *ppMaterials, HANDLE *ppEffectInstances, DWORD *pMatOut, HANDLE *ppSkinInfo, HANDLE *ppMesh);
